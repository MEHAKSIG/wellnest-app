...
const Report = () => {
  ...
  const fetchReports = async () => {
    if (!user?.uid) return;
    const data = await getVaultFilesByType(user.uid, 'report');
    setReports(
      data.map((file) => ({
        id: file.id,
        uri: file.file_url,
  ...
  const handleUpload = async () => {
    await pickDocument(user.uid, 'report', setReports, setProgressMessage);
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.innerCard}>
          ...
          <Text style={styles.subtitle}>
            Securely upload and view your medical reports
          </Text>
          ...
          {progressMessage ? (
            <Text style={{ marginTop: 10, color: '#b71c1c' }}>{progressMessage}</Text>
          ) : null}
...
//           <TouchableOpacity
//             style={styles.uploadBtn}
//             onPress={() => pickDocument('Report', setReports, setProgressMessage)}
//           >
//             <AntDesign name="addfile" size={22} color="#fff" />
//             <Text style={styles.uploadText}>Upload Report</Text>
//           </TouchableOpacity>
...
// //           <Text style={styles.title}>📄 Report Vault</Text>
// //           <Text style={styles.subtitle}>
// //             Securely store and view your health PDFs
// //           </Text>
...
// // export default PdfReportUploader;
